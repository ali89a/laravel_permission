        ...
        <div class="content container-fluid">
            <div class="row">
                ...
                <div class="col-xs-5 text-right m-b-30">
                    <a href="{{ route('permission.index') }}" class="btn btn-primary rounded"><i class="fa fa-list-ul"></i> See List</a>
                </div>
            </div>
            <div class="card-box">
                <div class="row">
                    <div class="col-md-12">
                        {{ BootForm::horizontal(['model'=>$model, 'store' => 'permission.store', 'update' => 'permission.update'])}}
